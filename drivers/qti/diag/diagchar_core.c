...
#endif
#ifdef CONFIG_QTI_DIAG_OVER_USB
...
static unsigned int itemsize_pcie_apps = 0;
...
#ifdef CONFIG_QTI_DIAGFWD_BRIDGE_CODE
...
#ifdef CONFIG_QTI_DIAG_OVER_PCIE
...
static int __init diagchar_init(void)
{
	...
	if (IS_ENABLED(CONFIG_QTI_DIAGFWD_BRIDGE_CODE))
